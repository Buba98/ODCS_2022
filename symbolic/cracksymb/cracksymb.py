...
def main():
    param_1 = [BitVec(f'{i}', 8) for i in range(23)]
    s = Solver()

    s.add(param_1[0] == 0x66)
    s.add(param_1[1] == 0x6c)
    s.add(param_1[2] == 0x61)
    s.add(param_1[3] == 0x67)
    s.add(param_1[4] == 0x7B)
    s.add(param_1[22] == 0x7D)
